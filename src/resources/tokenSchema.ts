...
export const tokenSchemaResourceInfo = {
  ...
  description: 'Annotated schema for build_token: design axes, field reference, approval patterns, permission presets, and validation checklist',
...
| standards | string[] | @pattern "Fungible Tokens", "NFTs", "Smart Token", "Liquidity Pools", "NFTMarketplace", "Tradable", "NFTPricingDenom:DENOM", "DefaultDisplayCurrency:DENOM" |
